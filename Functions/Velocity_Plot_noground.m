function Velocity_Plot_noground(Nfx, Nfy, x_lim, y_lim, q_1, q_2, q_3, gamma_1, ...
...
for i = 1:Nfx
    for j = 1:Nfy
        u_aux = TotalVelocity_X3 (q_1, q_2, q_3, gamma_1, gamma_2, gamma_3, u_inf, x(i), y(j), nacapane_1, nacapane_2, nacapane_3, N1, N2, N3);
