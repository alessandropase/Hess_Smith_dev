function [A, b, center_1, center_2, center_3, tau1_1, tauN_1] = Matrix_definition(nacapane_1, nacapane_2, nacapane_3, N1, N2, N3, u_inf)
...
for i = 1 : N1
    ...
    for j = 1 : N1
        ...
        A_s_11(i,j) = u_sorg' * n;                                          % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_11(i) = a_v_11(i) + u_vort' * n;                                     % DEFINITION OF ELEMENT i OF a_v 
        
        if i == 1                                                           % IF-CYCLE TO DEFINE c_s AND c_v COEFFICIENT
          c_s_1(j) = u_sorg' * tau1_1;
          c_v_1(j) = u_vort' * tau1_1;
        end
        if i == N1
          c_s_N(j) = u_sorg' * tauN_1;
          c_v_N(j) = u_vort' * tauN_1;
        end
    end
...
for i = 1 : N1
    ...
    for j = 1 : N2
        ...
        A_s_12(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_12(i) = a_v_12(i) + u_vort'* n;                  % DEFINITION OF ELEMENT i OF a_v 
...
for i = 1 : N1
    ...
    for j = 1 : N3
        ...
        A_s_13(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_13(i) = a_v_13(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
...
for i = 1 : N2
    ...
    for j = 1 : N1
        ...
        A_s_21(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_21(i) = a_v_21(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
        
        if i == 1                                                           % IF-CYCLE TO DEFINE c_s AND c_v COEFFICIENT
          c_s_1(j) = u_sorg' * tau1_2;
          c_v_1(j) = u_vort' * tau1_2;
        end
        if i == N2
          c_s_N(j) = u_sorg' * tauN_2;
          c_v_N(j) = u_vort' * tauN_2;
        end
    end
...
for i = 1 : N2
    ...
    for j = 1 : N2
        ...
        A_s_22(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_22(i) = a_v_22(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
...
for i = 1 : N2
    ...
    for j = 1 : N3
        ...
        A_s_23(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_23(i) = a_v_23(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
...
for i = 1 : N3
    ...
    for j = 1 : N1
        ...
        A_s_31(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_31(i) = a_v_31(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
        
        if i == 1                                                           % IF-CYCLE TO DEFINE c_s AND c_v COEFFICIENT
          c_s_1(j) = u_sorg' * tau1_3;
          c_v_1(j) = u_vort' * tau1_3;
        end
        if i == N3
          c_s_N(j) = u_sorg' * tauN_3;
          c_v_N(j) = u_vort' * tauN_3;
        end
    end
...
for i = 1 : N3
    ...
    for j = 1 : N2
        ...
        A_s_32(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_32(i) = a_v_32(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
...
for i = 1 : N3
    ...
    for j = 1 : N3
        ...
        A_s_33(i,j) = u_sorg' * n;                            % DEFINITION OF ELEMENT i,j OF A_S SUBMATRIX
        a_v_33(i) = a_v_33(i) + u_vort' * n;                  % DEFINITION OF ELEMENT i OF a_v 
