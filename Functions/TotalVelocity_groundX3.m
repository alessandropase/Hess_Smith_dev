...
for i = 1 : N3
    ...
    Estremo_1_m = [nacapane_3.x_pane_m(i); nacapane_3.y_pane_m(i)];               
    Estremo_2_m = [nacapane_3.x_pane_m(i+1); nacapane_3.y_pane_m(i+1)];           
    ...
    u_tot_3 = u_tot_3 + (u_sorg+u_sorg_m)*q_3(i) + gamma_3*(u_vort-u_vort_m);
end
